...
;(function () {
  ...
  ;(b = window.device), (a = {}), (window.device = a), (d =
    window.document
      .documentElement), (j = window.navigator.userAgent.toLowerCase()), (a.ios = function () {
    ...
    var b = null
    g(a) ||
      ((b = d.className.replace(/^\s+|\s+$/g, '')), (d.className = b + ' ' + a))
  }), (i = function (a) {
    g(a) && (d.className = d.className.replace(' ' + a, ''))
  }), a.ios()
    ? a.ipad()
      ? c('ios ipad tablet')
      : a.iphone() ? c('ios iphone mobile') : a.ipod() && c('ios ipod mobile')
    : a.android()
      ...
      : a.blackberry()
        ...
        : a.windows()
          ? c(
            a.windowsTablet()
              ? 'windows tablet'
              : a.windowsPhone() ? 'windows mobile' : 'desktop'
          )
          : a.fxos()
            ...
            : a.meego()
              ...
              : a.nodeWebkit()
                ...
                : a.television()
                  ? c('television')
                  : a.desktop() && c('desktop'), a.cordova() &&
    c('cordova'), (f = function () {
    a.landscape()
    ...
    : window.attachEvent
      ...
      : (window[h] = f), f(), typeof define === 'function' &&
