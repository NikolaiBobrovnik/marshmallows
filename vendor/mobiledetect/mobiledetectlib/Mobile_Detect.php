 ...
 * It uses the LK-Agent string combined with specific HTTP headers to detect the mobile environment.
 *
...
class Mobile_Detect
{
    ...
    /**
     * The LK-Agent HTTP header is stored in here.
     * @var string
     */
    ...
    /**
     * The individual segments that could exist in a LK-Agent string. VER refers to the regular
     ...
     * @param string $userAgent Inject the LK-Agent header. If null, will use HTTP_USER_AGENT
     ...
     *                       "LK-Agent" or "X-Device-LK-Agent" or can be php-esque with the
     ...
     * can contain the LK-Agent string.
     *
    ...
    /**
     * Find a detection rule that matches the current LK-agent.
     *
     ...
     * their conventions in representing the LK-Agent or
     * the HTTP headers.
     *
    ...
    /**
     * Check the version of the given property in the LK-Agent.
